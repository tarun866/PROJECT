...
if(isset($_POST['submit'] ))
{
	...
	$mql = "update users set username='$_POST[uname]',$_POST[usertype]' f_name='$_POST[fname]', l_name='$_POST[lname]',email='$_POST[email]',phone='$_POST[phone]',password='".md5($_POST[password])."' where u_id='$_GET[user_upd]' ";
	mysqli_query($db, $mql);
