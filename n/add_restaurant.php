    ...
    <div id="main-wrapper">
       ...
       <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="D:\xampp\htdocs\OnlineFood-PHP\indexowner.php">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a href="dashboardowner.php"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li> -->
